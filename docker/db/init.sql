...
(1, 1, '2026-01-11 10:00:00', '2D', 25.00),
(1, 1, '2026-01-11 14:00:00', '2D', 25.00),
(1, 2, '2026-01-11 18:30:00', 'IMAX 3D', 35.00),
(1, 2, '2026-01-11 21:00:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-12 10:00:00', '2D', 25.00),
(1, 2, '2026-01-12 16:00:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-13 14:30:00', '2D', 25.00),
(1, 2, '2026-01-13 19:00:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-14 10:00:00', '2D', 25.00),
(1, 2, '2026-01-14 20:30:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-15 15:00:00', '2D', 25.00),
(1, 2, '2026-01-15 18:00:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-16 11:00:00', '2D', 25.00),
(1, 2, '2026-01-16 19:30:00', 'IMAX 3D', 35.00),
(1, 1, '2026-01-17 13:00:00', '2D', 25.00),
(1, 2, '2026-01-17 20:00:00', 'IMAX 3D', 35.00),

-- Kung Fu Panda (movie_id=2) - Warszawa
(2, 1, '2026-01-11 12:00:00', '2D', 20.00),
(2, 1, '2026-01-11 16:00:00', '2D', 20.00),
(2, 1, '2026-01-12 12:30:00', '2D', 20.00),
(2, 1, '2026-01-12 18:00:00', '2D', 20.00),
(2, 1, '2026-01-13 11:00:00', '2D', 20.00),
(2, 1, '2026-01-13 16:30:00', '2D', 20.00),
(2, 1, '2026-01-14 12:00:00', '2D', 20.00),
(2, 1, '2026-01-14 17:00:00', '2D', 20.00),

-- Oppenheimer (movie_id=3) - Warszawa
(3, 2, '2026-01-11 15:00:00', 'IMAX 3D', 32.00),
(3, 2, '2026-01-11 19:30:00', 'IMAX 3D', 32.00),
(3, 2, '2026-01-12 14:00:00', 'IMAX 3D', 32.00),
(3, 2, '2026-01-12 20:00:00', 'IMAX 3D', 32.00),

-- Diuna (movie_id=1) - Kraków
(1, 3, '2026-01-11 11:00:00', '2D', 23.00),
(1, 3, '2026-01-11 15:30:00', '2D', 23.00),
(1, 5, '2026-01-11 19:00:00', 'IMAX 3D', 33.00),
(1, 5, '2026-01-11 21:30:00', 'IMAX 3D', 33.00),
(1, 3, '2026-01-12 10:30:00', '2D', 23.00),
(1, 5, '2026-01-12 17:00:00', 'IMAX 3D', 33.00),
(1, 3, '2026-01-13 13:00:00', '2D', 23.00),
(1, 5, '2026-01-13 18:30:00', 'IMAX 3D', 33.00),
(1, 3, '2026-01-14 11:00:00', '2D', 23.00),
(1, 5, '2026-01-14 20:00:00', 'IMAX 3D', 33.00),

-- Kung Fu Panda (movie_id=2) - Kraków
(2, 4, '2026-01-11 13:00:00', '2D', 18.00),
(2, 4, '2026-01-11 17:00:00', '2D', 18.00),
(2, 4, '2026-01-12 12:00:00', '2D', 18.00),
(2, 4, '2026-01-12 16:30:00', '2D', 18.00),

-- Oppenheimer (movie_id=3) - Kraków
(3, 5, '2026-01-11 14:00:00', 'IMAX 3D', 30.00),
(3, 5, '2026-01-11 20:00:00', 'IMAX 3D', 30.00),
(3, 5, '2026-01-12 15:00:00', 'IMAX 3D', 30.00),
(3, 5, '2026-01-12 19:30:00', 'IMAX 3D', 30.00);
